...
app.get('/', async (request, response) => response.status(200).send('I dream of being a website.'));

// There will be a test page available on the /test path of your server url
// Remove this before launching your app
app.get('/hello', async (request, response) => response.sendFile(path.join(__dirname, '/hello.html')));
